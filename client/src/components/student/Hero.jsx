...
return (
    ...
    text-gray-800 max-w-3xl mx-auto'>Empower your future with courses designed to <span className="text-blue-600">fit your choices.</span>
    ...
    community to help you acheive your personal and professional goals.
    </p>
    <p className='md:hidden text-gray-500 max-w-2sm mx-auto'>
    We bring together world-class instructors, interactive-content, and a supportive 
    community to help you acheive your personal and professional goals.
    </p>
    <SearchBar />
