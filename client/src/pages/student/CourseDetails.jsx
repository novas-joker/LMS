  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
                    ...
                    <div className="pt-8 text-gray-800">
                      ...
                      <div className='pt-5'>
                          {courseData.courseContent.map((chapter,i)=>
                            <div className='border border-gray-300 bg-white mb-2 rounded'key={i}>
                              <div className='flex items-center justify-between px-4 py-3 cursor-pointer 
                              select-none' onClick={()=>toggleSection(i)}>
                                <div className='flex items-center gap-2'>
                                  <img src={assets.down_arrow_icon} alt="arrow icon" className={`transform transition-transform ${openSections[i]?'rotate-180':''}`}/>
                              ...
                              <div className={`overflow-hidden transition-all duration-300 ${openSections[i]? 'max-h-96' : 'max-h-0'}`}>
      ...
      min-w-[300px] sm:min-w-[420px]'>
        ...
        playerVars:{ autoplay: 1}}} iframeClassName='w-full aspect-video'/>:
        ...
        <div className='p-5'>
          ...
          <div className='flex items-center text-sm text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
