    ...
    <div className="min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pb-0">
      <div className="space-y-5">
        <div className="flex flex-wrap gap-5 items-center">
           <div className="flex tems-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md">
        ...
        bg-white border border-gray-500/20">
          <table className="table-fixed md:table-auto w-full overflow-hidden">
            <thead className="text-gray-900 border-b border-graay-500/20 text-sm text-left">
              <tr>
